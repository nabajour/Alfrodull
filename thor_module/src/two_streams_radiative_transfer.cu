...
void two_streams_radiative_transfer::print_config() {
    ...
    printf("Alf_R_planet: %f [R_EARTH]\n", R_planet_config);
    printf("Alf_R_star: %f [R_SUN]\n", R_star_config);
...
bool two_streams_radiative_transfer::configure(config_file& config_reader) {
    ...
    config_reader.append_config_var("Alf_R_star", R_star_config, R_star_config);
    config_reader.append_config_var("Alf_R_planet", R_planet_config, R_planet_config);
    ...
    // orbit/insolation properties
    config_reader.append_config_var("Alf_sync_rot", sync_rot_config, sync_rot_config);
    config_reader.append_config_var("Alf_mean_motion", mean_motion_config, mean_motion_config);
    config_reader.append_config_var("Alf_alpha_i", alpha_i_config, alpha_i_config);
    config_reader.append_config_var("Alf_true_long_i", true_long_i_config, true_long_i_config);
    config_reader.append_config_var("Alf_ecc", ecc_config, ecc_config);
    config_reader.append_config_var("Alf_obliquity", obliquity_config, obliquity_config);
    config_reader.append_config_var("Alf_longp", longp_config, longp_config);
...
bool two_streams_radiative_transfer::initialise_memory(
    ...
    R_planet_SI         = R_planet_SI * R_EARTH;
    ...
    alf.set_parameters(nlayer,              // const int&    nlayer_,
                       ...
                       R_planet_SI,         // const double& R_planet_,
